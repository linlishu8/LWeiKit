...
+ (UIImage *)lw_GetRoundImagewithImage:(UIImage *)image {
...
//生成一张纯色的图片
+ (UIImage *)lw_imageWithColor:(UIColor *)color alpha:(CGFloat)alpha size:(CGSize)size {
...
+ (UIImage *)lw_imageWithColor:(UIColor *)color alpha:(CGFloat)alpha {
    CGSize size = CGSizeMake(1.0f, 1.0f);
    return [self lw_imageWithColor:color alpha:alpha size:size];
}

+ (UIImage *)lw_imageWithColor:(UIColor *)color {
    return [self lw_imageWithColor:color alpha:1.0];
}
...
- (UIImage *)lw_imageWithTitle:(NSString *)title fontSize:(CGFloat)fontSize titleColor:(UIColor *)titleColor {
    //画布大小
...
- (UIImage *)lw_updateImageWithTintColor:(UIColor*)color alpha:(CGFloat)alpha {
    ...
    return [self lw_updateImageWithTintColor:color alpha:alpha rect:rect];
}

- (UIImage *)lw_updateImageWithTintColor:(UIColor *)color alpha:(CGFloat)alpha rect:(CGRect)rect {
