...
+ (instancetype)lw_colorWithHex:(uint32_t)hex {
    ...
    return [self lw_colorWithRed:r green:g blue:b];
}

+ (instancetype)lw_randomColor {
    return [UIColor lw_colorWithRed:arc4random_uniform(256) green:arc4random_uniform(256) blue:arc4random_uniform(256)];
}
...
+ (UIColor *)lw_gradientFromColor:(UIColor *)c1 toColor:(UIColor *)c2 withHeight:(CGFloat)height {
