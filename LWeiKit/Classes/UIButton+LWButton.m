...
- (UIButton *(^)(NSString *))normalBackgroundImage {
    return ^(NSString *normalBackgroundImage) {
        [self setBackgroundImage:[UIImage imageNamed:normalBackgroundImage] forState:UIControlStateNormal];
        return self;
    };
}

- (UIButton *(^)(NSString *))selectedBackgroundImage {
    return ^(NSString *selectedBackgroundImage) {
        [self setBackgroundImage:[UIImage imageNamed:selectedBackgroundImage] forState:UIControlStateSelected];
        return self;
    };
}
...
- (UIButton *(^)(UIColor *))normalBackgroundColor {
    return ^(UIColor *normalBackgroundColor) {
...
- (UIButton *(^)(UIEdgeInsets))normalTextEdgeInset {
    return ^(UIEdgeInsets normalTextEdgeInset) {
        [self setTitleEdgeInsets:normalTextEdgeInset];
        return self;
    };
}

- (UIButton *(^)(UIEdgeInsets))normalImageEdgeInset {
    return ^(UIEdgeInsets normalImageEdgeInset) {
        [self setImageEdgeInsets:normalImageEdgeInset];
        return self;
    };
}
...
- (void)lw_addActionHandler:(TouchedButtonBlock)touchHandler {
    objc_setAssociatedObject(self, @selector(lw_addActionHandler:), touchHandler, OBJC_ASSOCIATION_COPY_NONATOMIC);
...
- (void)blockActionTouched:(UIButton *)btn {
    TouchedButtonBlock block = objc_getAssociatedObject(self, @selector(lw_addActionHandler:));
    if (block) {
        block();
    }
}
