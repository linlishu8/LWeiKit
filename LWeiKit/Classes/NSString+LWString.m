...
- (NSString*)lw_substringWithinBoundsLeft:(NSString*)strLeft right:(NSString*)strRight {
    NSRange rangeSub;
    NSString *strSub;
...
/**
 ...
 @return 返回的中文数字
 */
+ (NSString *)lw_translation:(NSString *)arebic {
    NSString *str = arebic;
...
- (NSString *)lw_reverseWordsInString:(NSString*)str {
...
+ (NSString *)lw_transform:(NSString *)chinese {
